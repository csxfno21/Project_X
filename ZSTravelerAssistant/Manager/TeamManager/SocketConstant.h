...
//  ZSTravelerAssistant
//
//  Created by csxfno21 on 13-10-28.
...
#define  TEAM_HOST                                  @"xxx.xxx.xxx.xxx"
...
typedef enum{
    ...
    FC_RECEIVE_MODIFIINFORESULT         = 117,      // 修改资料成功后返回结果
    ...
    FC_RECEIVE_NEWTEAMMAT               = 129,      // 团队新增队友，推送
    FC_RECEIVE_QUITTEAMVISITORINFO      = 128,      // 主动推送退团游客信息
...
typedef enum
{
    SC_SINGEL_MESSAGE        = 10000,       //发送单人消息
    SC_GROUP_MESSAGE         = 10001,       //群发消息
    
}SC_COMMEND_CODE;


typedef enum MeesageState
{
    MESSAGE_STATE_SENDDING = 0,
